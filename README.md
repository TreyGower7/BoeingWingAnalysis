...
```bash
.
├── mesh/                    # Mesh files for the 3D wing geometry
├── cases/                   # OpenFOAM cases for different AoA and Re
├── scripts/                 # Bash/Python scripts for batch runs and post-processing
├── results/                 # Processed simulation results and plots
├── figures/                 # Flow visualization images and convergence plots
└── report/COE_379L_Final_Report.pdf  # Final report (April 30, 2025)
